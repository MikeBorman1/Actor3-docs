...
a title/section is created using a "#" for a big title or a "##" for a smaller 
one each section creates the navigation for that page so use it for every distinct element
